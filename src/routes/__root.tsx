...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Magsmen Portal — Realtime Task Management Platform" },
      {
        name: "description",
        content:
          "Client, team and admin portals with task CRUD, ClickUp two-way sync, analytics and realtime notifications.",
      },
      { property: "og:title", content: "Magsmen Portal — Realtime Task Management Platform" },
      {
        property: "og:description",
        content: "Three portals, task CRUD, ClickUp two-way sync and analytics in one workspace.",
      },
